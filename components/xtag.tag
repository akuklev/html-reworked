...
this.on('mount', function() {
  ...
  var adjustSize = function() {
    ...
    console.log(window.getComputedStyle(that.refs.bra).getPropertyValue("height") + 1/d);
    console.log(window.getComputedStyle(that.refs.bra, ':before').getPropertyValue("marginLeft"));
    that.update({
